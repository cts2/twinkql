...
public class DefaultTwinkqlContext implements TwinkqlContext {
	...
	public SparqlMap getSparqlMap(String namespace, String mapId) {
		return this.doGetSparqlMap(
				this.sparqlMappings.get(namespace), mapId);
	}
	 ...
	 */
	protected SparqlMap doGetSparqlMap(SparqlMappings mapping, String mapId){
		for(SparqlMap map : mapping.getSparqlMapList()){
