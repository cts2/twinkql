 ...
 */
@Component
public class ResultBindingProcessorLegacy implements InitializingBean {
	...
	public ResultBindingProcessorLegacy() {
		super();
	}
	 ...
	 *            the twinkql context
	 */
	public ResultBindingProcessorLegacy(TwinkqlContext twinkqlContext) {
